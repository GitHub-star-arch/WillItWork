...
export default class WelcomeScreen extends React.Component {
    ...
    userLogIn = (email, password) => {
        firebase.auth().signInWithEmailAndPassword(email, password).then((response) => { return alert("User Entered Successfully"), this.props.navigation.navigate('Sell') }).catch(function (error) { var errorcode = error.code; alert(error.message) });
